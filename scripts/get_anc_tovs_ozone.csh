...
#------------------------------------------------------------------------------
# Get the TOVS ancillary data file closest to a given date (yyyyddd)
#
...
if ($#argv != 1) then
  echo "Usage: get_anc_tovs_ozone.csh date"
  echo "where"
...
# Set TOVS OZONE filename head and tail
set file_head = ""
set file_tail = ".grb"
...
echo "ERROR: Ancillary TOVS ozone file could not be found" > /dev/stderr
exit 1
