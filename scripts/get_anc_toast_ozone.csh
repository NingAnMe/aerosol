...
#------------------------------------------------------------------------------
# Get the TOAST ancillary data file closest to a given date (yyyyddd)
...
if ($#argv != 1) then
  echo "Usage: get_anc_toast_ozone.csh date"
  echo "where"
...
# Set TOAST filename head and tail
set file_head = "TOAST16_"
set file_tail = ".GRB"

# Set TOVS date range (7 day window centered on following day)
...
echo "ERROR: Ancillary TOAST ozone file could not be found" > /dev/stderr
exit 1
