...
#------------------------------------------------------------------------------
# Get the NISE ancillary data file closest to a MODIS date (yyyyddd)
#
...
if ($#argv != 1) then
  echo "Usage: get_anc_nise.csh date"
  echo "where"
...
set file_head = "NISE_SSMIF13_20"
set file_tail = ".HDFEOS"
...
echo "ERROR: Ancillary NISE file could not be found" > /dev/stderr
exit 1
