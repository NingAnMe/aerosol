...
/* NOTE:  (From Phuong T. Nguyen - L3 Communication Corp.)
   This file was copied from /usr/include/regexp.h and modified to be fine 
   for the toolkit's running on g++ compiler of linux.  The "unsigned char *"
   has been added to line 131 and some "char *"s have been added to RETURN values.*/
